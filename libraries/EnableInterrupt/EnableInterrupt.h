// Ініціалізація блоку задання переривань та їх відслідковуваня
...
// Пакет макросів для різних платформ
...
// Макрос ініціалізації переривання
...
// Ініціалізація кінцевих прототипних функцій та макросів
...
// Блок сценаріїв виклику бібліотеки
...
// Блок взаємодії на споживання ресурсів процесора
#define EI_printPSTR(x) EI_SerialPrint_P(PSTR(x))
void EI_SerialPrint_P(const char *str) {
  for (uint8_t c; (c = pgm_read_byte(str)); str++) Serial.write(c);
} 

// Утіліта транспозиції для цифрових пінів
volatile uint8_t *pcmsk;

// Дублюючий блок деталей
#define PA 1
#define PB 2
#define PC 3
#define PD 4
...
// Специфікаційний пакет структурних даних
...
// Блок ініціалізації цифрових портів
...
// Блок опису сруктурних даних та умов переривань на утилітах
...
// Регістр зростаючих та спданих значень
...
// Функція взаємодії з ICR та PRICR
...
// Блок обробки цифрових переривань
void disableInterrupt (uint8_t interruptDesignator) {
...
// Блок ініціалізації даних для різних платформ і роботи з регісторним перевизначенням
#ifndef EI_NOTEXTERNAL
#ifndef EI_NOTINT0
ISR(INT0_vect) {
#ifndef NEEDFORSPEED
